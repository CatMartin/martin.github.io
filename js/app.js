...
var app = {
	...
	copy: [
		...
		'Может познакомимся? Меня Андрей зовут :)',
		'Почему ты вообще здесь находишься?',
		'Хм, может ты ищешь способ связаться со мной?',
		'Больше всего времени я провожу в ВК. <a href="https://vk.me/martin__cat" target="_blank">Жми сюда, чтобы написать мне</a>. Ну а если я не прав - нажми кнопку еще раз.',
		'Когда тебе уже надоест это делать?',
		'Ладно, может, тебе хочется посмотреть на свою скорость интернета?',
		'<iframe width="100%" height="650px" frameborder="0" src="http://martincat.speedtestcustom.com"></iframe>',
		'Ты все еще тут?',
